...
const EditBook = ({ match, location }) => {
  ...
  const updateBook = () => {
    ...
    setStatus("loading");
    Axios.put(`/api/v1/book/${key}`, { ...formData })
      .then((response) => {
        setStatus("success");
      })
      .catch((err) => {
  ...
  return (
    <div>
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-semibold text-gray-900">Editar libro</h1>
